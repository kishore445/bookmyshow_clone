...
theatreRouter.post("/get-all-shows-by-theatre", validateJWTToken, getAllShowsByTheatre);
theatreRouter.post("/getAllTheatresByMovie", validateJWTToken, getAllTheatresByMovie);
